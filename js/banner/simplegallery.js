...
var simpleGallery_navpanel={
	panel: {height:'55px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Verdana'}, //customize nav panel container
...
simpleGallery.routines={
	...
	getSlideHTML:function(imgelement){
		var layerHTML=(imgelement[1])? '<a href="'+imgelement[1]+'" target="_blank">\n' : ''
